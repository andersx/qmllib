...
def get_global_symmetric_kernels(
    ...
    return fget_global_symmetric_kernels_fchl(
        A,
        verbose,
        N1,
        neighbors1,
...
def get_global_kernels(
    ...
    return fget_global_kernels_fchl(
        A,
        B,
        verbose,
        N1,
...
def get_atomic_kernels(
    ...
    return fget_atomic_kernels_fchl(
        A,
        B,
        verbose,
        neighbors1,
...
def get_atomic_symmetric_kernels(
    ...
    return fget_atomic_symmetric_kernels_fchl(
        A,
        verbose,
        neighbors1,
        na1,
...
def get_atomic_local_kernels(
    ...
    return fget_atomic_local_kernels_fchl(
        A,
        B,
        verbose,
        N1,
